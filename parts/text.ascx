...
<div class="LB250307candy articleContainer" id="LB250307candy">
    ...
    <div class="sec_1__inner">
      <div class="sec_1__img_1_wrap js-fadeIn">
        <div class="sec_1__img_1">
          <a href="<%= Constants.PATH_ROOT %>Form/Product/ProductList.aspx?shop=0&pgi=LB250307candy01">
            <picture>
              <source srcset="./img/sp_film_2_03.jpg" media="(max-width: 767px)" type="image/jpg" class="sec_1__img_1__img">
              <img src="./img/film_2_03.jpg" alt="" class="sec_1__img_1__img">
            </picture>
          </a>
        </div>
      </div>
      ...
      <div class="sec_1__img_2_warp">
        <a href="" class=" js-fadeInReplace pc-only">
        ...
        <a href="" class=" js-fadeInReplace sp-only">
          <img src="./img/sp_film_1_01.jpg" alt="" class="sec_1__img_2 sec_1__img_2--1 replace__img visible js-replaceImg">
          <img src="./img/sp_film_3_01.jpg" alt="" class="sec_1__img_2 sec_1__img_2--2 replace__img js-replaceImg">
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="sec_9 js-fadeIn">
    <div class="sec_9__img_wrap">
      <a href="">
        <picture>
          <source srcset="./img/sp_film_9_10.jpg" media="(max-width: 767px)" class="sec_9__img">
